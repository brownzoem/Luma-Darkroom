...
Examples of representing the community include using an official account,
posting through an official social media account, or acting as an appointed
representative at an event.

## Reporting

Report abuse, harassment, or other unacceptable behavior through the repository
hosting platform's private maintainer-contact or private reporting mechanism.
Do not include sensitive conduct details in a public issue. If no private
mechanism is visible, open a minimal issue asking maintainers to establish a
private reporting channel, without naming people or describing the incident.

Reports will be reviewed by maintainers who are not implicated in the report
when that is reasonably possible. Maintainers will seek to respect the privacy
and safety of reporters and affected community members, but cannot promise
absolute confidentiality, a particular outcome, or a fixed response time.
