...
(async()=>{
  ...
  const report={presetSwitch,controls,checks,autoWhiteBalance,selectState,curvePoints:curve.length,batch,compareState,shortcutMarked,watermarks,overlap,security,errors};
